...
//                }
        ...
        callback: function (editor, $w, url, state) {
            if (state == "SUCCESS") {
                ...
                var data = "http://192.168.3.116/cluster/stream/images/"
                        //显示图片计数+1
                        Upload.showCount++;
                        var $img = $("<img src='" + data + url + "' class='edui-image-pic' />"),
                            $item = $("<div class='edui-image-item edui-image-upload-item'><div class='edui-image-close' onclick='deleteElement(this)'></div></div>").append($img);
