...
<head>
    ...
    <link href="${ctxurl}/resources/webPage/ueditor/themes/default/css/umeditor.css" type="text/css" rel="stylesheet">
    <script type="text/javascript" src="${ctxurl}/resources/webPage/ueditor/third-party/jquery.min.js"></script>
    <script type="text/javascript" src="${ctxurl}/resources/webPage/ueditor/third-party/template.min.js"></script>
    <script type="text/javascript" charset="utf-8" src="${ctxurl}/resources/webPage/ueditor/umeditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="${ctxurl}/resources/webPage/ueditor/umeditor.min.js"></script>
    <script type="text/javascript" src="${ctxurl}/resources/webPage/ueditor/lang/zh-cn/zh-cn.js"></script>
    <style type="text/css">
        h1 {
            font-family: "微软雅黑";
            font-weight: normal;
