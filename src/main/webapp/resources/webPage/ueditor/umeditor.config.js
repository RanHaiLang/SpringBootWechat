...
(function () {
    ...
    // 原本是请求后台，获取apache路径，后因转发，请求路径不稳定，改为写死的方式
    /*$.ajax({
         url:getRootPath()+"/ueditor/imagePathapq",
         type:'GET',
         aysn:false,
         success:function(data){
             localstroage.setItem("urlImage",data["imgUrl"]);*/
             localstroage.setItem("urlImage","http://192.168.3.116/cluster/stream/images/");
             localstroage.getItem("urlImage");
             console.log(localstroage.getItem("urlImage"));
         /*}
     });*/
   ...
   /* $.ajax({
        url: getRootPath()+'/ueditor/getPath',
        type: "POST",
        success: function (data) {*/
            window.UMEDITOR_CONFIG = {
                ...
                ,imagePath:localstroage.getItem("urlImage")                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置      URL + "jsp/"
